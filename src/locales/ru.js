export default {
    ...
    create_token: {
        ...
        name: 'Token Name',
        symbol: 'Token Symbol',
        decimal: 'Decimals (It\'s recommended to set decimals to 8 in BORSH)',
    ...
    restore_ledger: {
        ...
        usage: 'Please ensure your firmware and app are the newest version. Plugin your Ledger, open Borsh APP, and then click the "CONNECT" button below try to connect.',
        download: 'No Borsh APP? Please install it follow this https://www.ledgerwallet.com/apps/manager',
        connect: 'CONNECT'
    },
    view: {
